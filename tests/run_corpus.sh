...
KNOWN_NOBUILD="autoproject box compileerror defaults dobreak genericfileunit genericfunctions generics linkedlist numeric_generics ownership specs xunit_io_method"
