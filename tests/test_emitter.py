...
class TestAutoGeneratedEquality:
    ...
    def test_record_eq_c_output(self):
        ...
        assert "a.x == b.x" in csource or "(a.x == b.x)" in csource
    ...
    def test_variant_eq_c_output(self):
        """Verify variant eq with tag+payload comparison."""
        csource = emit_source(
    ...
    def test_nested_record_eq_c_output(self):
        """Nested records call inner eq function in generated C."""
        csource = emit_source(
            "inner: record { v: i64 }\n"
