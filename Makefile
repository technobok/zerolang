...
# emitter-name-resolution:32 (typed-AST-authoritative — emitter reads stamps, not names; drive to 0)
bootstrap-lint:
	@fail=0; \
	...
	if [ $$count -gt 32 ]; then \
		echo "ERROR: emitter name-resolution calls increased ($$count > 32 baseline)"; \
