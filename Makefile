...
# emitter-name-resolution:11 (typed-AST-authoritative — emitter reads stamps, not names; drive to 0)
bootstrap-lint:
	@fail=0; \
	...
	if [ $$count -gt 11 ]; then \
		echo "ERROR: emitter name-resolution calls increased ($$count > 11 baseline)"; \
